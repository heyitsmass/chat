...
import { Join } from "../../hooks/useChatStore";
...
const isOutOfBounds = (
	rect: DOMRect,
	doc: DOMRect
): [boolean, Set<Bound>, Record<Bound, number>] => {
	const diffs = {
...
const TooltipContent = ({
	...
	return (
		<p
			ref={contentRef}
			className={twMerge(
				"tooltip-content mt-2 rounded-sm bg-zinc-800 text-white p-2 text-xs",
				position,
				className
			)}
